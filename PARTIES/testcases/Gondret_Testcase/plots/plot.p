...
set xrange [-0.3:2]
plot \
"../Reference_data/mobile_st_27_1.dat" u (($1-0.1667)/0.024731):($4/0.006-0.5) w l lc 1 lw 2 title "Reference data",\
...
set xrange [-0.5:10]
plot \
"../Reference_data/mobile_st_152.dat" u (($1/0.017487424)-20.6):(($4/0.003)-0.5) w l lc 1 lw 2 title "Reference data",\
