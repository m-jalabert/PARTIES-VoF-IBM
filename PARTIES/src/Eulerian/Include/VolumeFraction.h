...
//VOF_IBM functions
#ifdef VOF_WETTING
void Wetting_apply_contact_angle_on_PLIC(Cart3d_bag *bag);
void Wetting_apply_contact_angle_on_smooth_normals(Cart3d_bag *bag);

void VOF_build_extension_velocity_bottom_wall(Cart3d_bag *data_bag);
void VOF_extend_F_below_wall(Cart3d_bag *data_bag);
void VOF_wall_contact_angle_extend(Cart3d_bag *data_bag);
void VOF_PLIC_first_it(Cart3d_bag *data_bag);
void VOF_wall_contact_angle_extend_Lag(Cart3d_bag *data_bag);
#endif // VOF_WETTING
